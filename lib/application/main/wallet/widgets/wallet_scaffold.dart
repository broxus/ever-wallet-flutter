...
class _WalletScaffoldState extends State<WalletScaffold> {
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        body: ValueListenableBuilder<_ModalSize>(
          ...
          builder: (context, size, child) => SlidingUpPanel(
            ...
            boxShadow: const [
              BoxShadow(color: CrystalColor.shadow, offset: Offset(0, 8), blurRadius: 16)
            ],
                ...
                child: LayoutBuilder(
                  builder: (context, constraints) {
                    SchedulerBinding.instance.addPostFrameCallback(
                      (timeStamp) => _calculateModalHeight(constraints.maxHeight - 80),
                    );
  ...
  void _calculateModalHeight([double? height]) {
    ...
    final screenHeight = MediaQuery.of(context).size.height * 0.85 - 80;
