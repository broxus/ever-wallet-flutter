...
import 'package:ever_wallet/application/common/widgets/animated_offstage.dart';
...
class SeedPhraseCheckScreen extends StatefulWidget {
  ...
  @override
  State<SeedPhraseCheckScreen> createState() => _SeedPhraseCheckScreenState();
}
...
class _SeedPhraseCheckScreenState extends State<SeedPhraseCheckScreen> {
  ...
  Widget field(int index) => CustomTypeAheadField(
        ...
        textInputAction:
            index != kDefaultCheckingWordsAmount - 1 ? TextInputAction.next : TextInputAction.done,
