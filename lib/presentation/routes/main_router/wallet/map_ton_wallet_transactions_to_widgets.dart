...
import 'history/transactions_holders/ton_wallet_multisig_transaction_holder.dart';
          ...
          .where(
            (e) =>
                ...
                e.data!.maybeWhen(
                  walletInteraction: (info) => info.method.maybeWhen(
                    multisig: (multisigTransaction) => multisigTransaction.maybeWhen(
                      submit: (multisigSubmitTransaction) => multisigSubmitTransaction.transId == transactionId,
                      confirm: (multisigConfirmTransaction) =>
