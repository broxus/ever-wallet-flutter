...
class PrepareConfirmPage extends StatefulWidget {
  ...
  @override
  _PrepareConfirmPageState createState() => _PrepareConfirmPageState();
}

class _PrepareConfirmPageState extends State<PrepareConfirmPage> {
