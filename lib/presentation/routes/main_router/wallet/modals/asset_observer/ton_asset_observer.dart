...
class _TonAssetObserverState extends State<TonAssetObserver> {
                  ...
                  child: Column(
                    ...
                    children: [
                      SizedBox(
                        height: 24,
                        child: Text(
                          formatValue(contractState.balance.toTokens()),
  ...
  Widget _history() => BlocBuilder<TonWalletTransactionsBloc, TonWalletTransactions>(
              ...
              Flexible(
                child: RawScrollbar(
                  ...
                  child: PreloadTransactionsListener(
                    ...
                    onLoad: () => tonWalletTransactionsBloc.add(const TonWalletTransactionsEvent.preload()),
