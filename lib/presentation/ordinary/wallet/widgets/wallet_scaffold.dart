...
class _WalletScaffoldState extends State<WalletScaffold> {
  ...
  Widget build(BuildContext context) => Scaffold(
        ...
        body: ValueListenableBuilder<_ModalSize>(
          ...
          builder: (context, size, child) => SlidingUpPanel(
            ...
            boxShadow: const [BoxShadow(color: CrystalColor.shadow, offset: Offset(0, 8), blurRadius: 16.0)],
                ...
                child: LayoutBuilder(
                  builder: (context, constraints) {
                    SchedulerBinding.instance
                        ?.addPostFrameCallback((timeStamp) => _calculateModalHeight(constraints.maxHeight));
  ...
  void _calculateModalHeight([double? height]) {
    ...
    final screenHeight = context.screenSize.height * 0.85;
